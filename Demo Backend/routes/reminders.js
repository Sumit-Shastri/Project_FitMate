...
// Handles: VAPID key, subscribe, unsubscribe, send push, scheduled checks
//
// SETUP:
// npm install web-push node-cron
//
// Generate VAPID keys ONCE by running in terminal:
...
webpush.setVapidDetails(
  "mailto:" + (process.env.VAPID_EMAIL || "admin@fittrack.com"),
